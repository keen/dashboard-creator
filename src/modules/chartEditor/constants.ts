...
export const SHOW_QUERY_CHANGE_CONFIRMATION =
  '@chart-editor/SHOW_QUERY_CHANGE_CONFIRMATION';
export const HIDE_QUERY_CHANGE_CONFIRMATION =
  '@chart-editor/HIDE_QUERY_CHANGE_CONFIRMATION';
